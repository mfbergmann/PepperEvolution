...
- **src/world/** — `WorldModel`: who is around (from the bridge's debounced `people` events and the connect snapshot), summarised as the "Around you" line in the model's state block.
