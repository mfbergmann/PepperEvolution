...
Quick checks with a person present, same day: sonar (hand in front of the base: 0.32 m, clear: 0.7 m), emergency stop during a gesture (rests in 4.5 s), tablet text seen, head tracking followed a person from -48 to +83 degrees with a lock in 59 of 60 samples (it needs to see a face; walking past side-on may not register), web UI typed chat and hold-to-talk. Milestone 0 is complete except the base moves.
